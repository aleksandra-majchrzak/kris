...
<div class="panel panel-default col-lg-6 col-md-offset-1 details-panel" >
    ...
    <c:set var="itemsDoc" scope="page" value="${itemsDoc}"/>
    ...
    <div class="panel-body kris-panel-body">
        <div  id ="kris-panel-document-tabs" class=" col-lg-12">
            <ul class="nav nav-tabs">
                <li role="presentation" class="active"><a href="#document-tab-items">Towary</a></li>
                <li role="presentation"><a href="#document-tab-positions">Pozycje</a></li>
                <li role="presentation" ><a href="#document-tab-header">Nagłówek</a></li>
            </ul>

            <div id="document-tab-items" class="gone">
                <jsp:include page="/documents/document-items-view.jsp"  flush="true" />
            </div>
            ...
            <div id="document-tab-header" class="gone">
                <form role="form" action="DocumentServlet" method="post" >
                    <div class="list-group document-details-list-group">
                        <div class="form-group">
                            ...
                            <input  id = "doc-panel-number" type="datetime" name="number" placeholder="Numer dokumentu" class="form-control" value="${document.number}"/>
                            <c:if test="${document != null}">
                                <script type="text/javascript">
                                    $('#doc-panel-number').prop( "disabled", true );
                                </script>
                            </c:if>
                        </div>
                        <div class="form-group">
                            ...
                            <c:if test="${document != null}">
                                <script type="text/javascript">
                                    $('#docType').val('${document.type.value}');
              ...
              <%--          <div class="form-group">
                ...
                --%>        <div class="form-group">
                        ...
                        <div class="form-group">
                            <h4>Wartość netto</h4>
                            <input id = "doc-panel-net-value" type="number" step="0.01" name="netValue" placeholder="Wartosc" class="form-control" value="${document.netValue}"/>
                            <h4>Wartość brutto</h4>
                            <input id = "doc-panel-gross-value" type="number" step="0.01" name="grossValue" placeholder="Wartosc" class="form-control" value="${document.grossValue}"/>
                            <script type="text/javascript">
                                $('#doc-panel-net-value').prop( "disabled", true );
                                $('#doc-panel-gross-value').prop( "disabled", true );
                            </script>
                        </div>
                        <div class="form-group">
                            <h4>Opis</h4>
